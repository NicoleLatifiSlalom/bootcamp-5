---
description: "Development guidelines for the TODO application bootcamp project"
---
...
Link to existing documentation to help navigate the project:
...
Use specialized modes for specific tasks:
